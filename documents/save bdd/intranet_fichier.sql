...
CREATE TABLE `fichier` (
  ...
  CONSTRAINT `fk10` FOREIGN KEY (`id_sousdossier`) REFERENCES `sous_dossier` (`id_sousdossier`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `fichier` VALUES (19,6,'Epreuve D43 - Java - BARRIOL-VERCELLONI.pdf','2024-08-05 16:17:35',329379);
